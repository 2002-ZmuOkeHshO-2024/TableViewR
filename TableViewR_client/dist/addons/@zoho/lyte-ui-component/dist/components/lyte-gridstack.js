...
mouseup : function ( evt ){   
   ...
   evt.type && document.removeEventListener( isTch ? 'touchend' : 'mouseup', this.upfunc, true )
},
  ...
  click : function( event ) {
   ...
   mousebind : function(event){
        if( event.target != this && event.button != 2 ) {  
            ...
            if(!event.shiftKey){
                event.type && document.addEventListener( isTouch ? 'touchend' : 'mouseup', comp.upfunc, true );
            }
